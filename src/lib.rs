...
pub fn invert_2x2<S: Storage<Q231, U2, U2>>(
...
pub fn invert_3x3(matrix: &Matrix3<Q231>) -> Option<Matrix3<Q231>> {
    ...
    println!("ca_inv = {}", c * a_inv);
    println!("ca_inv * b = {}", c * a_inv * b);
    println!("d - ca_inv * b = {}", d - c * a_inv * b);
    println!("x_inv = {}", x_inv);
    println!("r1 = {}", r1);
    println!("r2 = {}", r2);
    println!("m = {}", m);
    println!("matrix * m = {}", matrix * m);
...
pub mod prelude {
    ...
    pub use super::{invert_2x2, invert_3x3};
}
...
mod tests {
    ...
    fn invert_matrix3(m: M3Q231) -> TestResult {
        match invert_3x3(&m.0) {
            None => TestResult::discard(),
            Some(inverted) => {
                let res = m.0 * inverted == Matrix3::identity();
                println!("res = {}", res);
